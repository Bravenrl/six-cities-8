...
function PropertyPage ({offers} : PropertyPagePropsType) : JSX.Element {
        ...
        <section className="property">
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              <PremiumMark isPremium = {isPremium} isPropertyPage/>
              ...
              {(goods.length) ? <PropertyList goods={goods} id={id}/> : ''}
